...
- [x] El torn, a mida del mòbil: fitxes grosses a la taula, que només
      s'encongeixen quan ja no hi caben perquè es vegin totes sense desplaçar
      res; el faristol el col·loques tu, un sol botó tanca el torn, i un
      rellotge de 30, 60 o 120 segons compta a la taula (quan s'acaba, es
      desfà el que no has validat i robes).
