...
export default defineConfig(({ command, isPreview }) => ({
  ...
  plugins: [react()],
  // @remigi/core és un paquet del workspace que publica codi font TypeScript
